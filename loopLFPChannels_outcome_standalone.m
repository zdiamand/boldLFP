...
function data = loopLFPChannels_outcome_standalone(channelIds,session)
% dataReplay = fullfile('D:\Olab\patientData\', session, '\dataReplay');
dataReplay = fullfile('E:\casinoTaskAnalysis\patientData\raw', session);
...
%         path = ['D:\Olab\shared\shared\neural\' session '\sessionData.mat'];
        path = ['F:\casinoTaskAnalysis\patientData\' session '\sessionData.mat'];
